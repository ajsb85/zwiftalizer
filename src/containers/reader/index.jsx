...
class Reader extends React.Component {
  ...
  render() {
    ...
    if (isLoading) {
      messageDiv = (
        <div className={styles.messageContainer}>Reading file ...</div>
      );
    }
    ...
    if (isFailure) {
      messageDiv = (
        <div className={styles.errorContainer}>
          Sorry, an error occurred reading the log file.<br />
          <br />
          Please report this as a{' '}
          <a
            href="https://github.com/mhanney/zwiftalizer/issues/new"
            target="_blank"
            onClick={this.handleNewIssueClick}
          >
            new issue
          </a>{' '}
          and attach the log that failed.
        </div>
      );
    }
              ...
              <div className="center-block">
                <div className="text-center">
                  ...
                  <h2 className={styles.checkboxLabel}>
                    I agree to share my system specs &nbsp;<a
                      href=""
          ...
          <Modal.Body>
            <div className={editorial.editorialBoxContentTransparent}>
              <div className="container-fluid">
                <div className="row">
                  <div className="col-xs-12">
                    <h3>What happens when the box is checked?</h3>
                    <p>
                      With the 'I agree' box checked, a summary of your system
                      is uploaded to the database in the background, but not the
                      whole log file. This box must be checked BEFORE loading a
                      log file. Checking it after loading a log file has no
                      affect.
                    </p>

                    <h3>Why would I want to upload my specs?</h3>
                    <p>
                      Uploads contribute to the benchmarks report that shows
                      graphics performance of various systems. This helps the
                      community make informed purchasing decisions.
                    </p>

                    <h3>Is my log file sent to a server?</h3>
                    <p>
                      No. I don't need them and I don't want the responsibility
                      of securing PII (Personally Identifiable Information). All
                      processing is done by JavaScript running in your web
                      browser. The results are sent to a database over secure
                      HTTPS.
                    </p>

                    <h3>Is the data anonymous?</h3>
                    <p>
                      Yes. PII is NOT used or stored in the database. Your Zwift
                      userid is NEVER read. The email address you use with Zwift
                      is NEVER read. The Zwiftalizer will NEVER ask for your
                      Zwift username or password.
                    </p>
                    <p>The following data is uploaded:</p>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xs-12 col-sm-6">
                        <ul>
                          <li>Graphics Resolution - 2160, 1440, 1080, etc</li>
                          <li>Shadow Resolution - 2048, 1024, 512, etc</li>
                          <li>
