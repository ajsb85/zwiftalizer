...
class Chart extends React.Component {
  ...
  render() {
    ...
    if (this.state.tracker) {
      ...
      const fpsAtTracker = Math.round(
        fpsCropped.at(fpsIndexAtTracker).get('value')
      );
      if (fpsAtTracker) {
                  ...
                  <Resizable>
                    ...
                    >
                      <ChartRow
                        ...
                        trackerHintHeight={30}
                      >
                        <LabelAxis
                          id="fpsAxis"
                          label="FPS"
                          values={this.state.fpsSummaryValues}
                          min={this.state.minOverall}
                          max={this.state.maxOverall}
                          width={100}
                          type="linear"
                          format="d"
                        />
                    ...
                    >
                      <ChartRow height={BRUSH_HEIGHT} debug={false}>
                        ...
                        <YAxis
                          id="fpsBrushAxis"
                          label="FPS"
                          min={this.state.minOverall - 5}
                          max={this.state.maxOverall + 5}
                          width={100}
                          type="linear"
                          format="d"
                        />
