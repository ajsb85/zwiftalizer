...
export { default as startDateTime } from './startDateTime';
...
export { default as shadowres } from './shadowres';

export { default as cpuVendor } from './cpuVendor';
...
export { default as openglMajor } from './openglMajor';

export { default as openglMinor } from './openglMinor';

export { default as toHoursMinutesSeconds } from './toHoursMinutesSeconds';

export { default as humanizeDuration } from './humanizeDuration';

/* untested */
export { default as zeroPad } from './zeroPad';

export { default as antDevices } from './antDevices';
...
export { default as stripFpsLines } from './stripFpsLines';

export { default as stripLoadingLines } from './stripLoadingLines';

export { default as mapAntLines } from './mapAntLines';

export { default as mapBTLELines } from './mapBTLELines';
...
export { default as mapCalibrationData } from './mapCalibrationData';

export { default as mapAntSearches } from './mapAntSearches';

export { default as epochify } from './epochify';

export { default as timerange } from './timerange';

export { default as timeAxis } from './timeAxis';

export { default as antManufacturers } from './antManufacturers';

export { default as mapAntRxFails } from './mapAntRxFails';
